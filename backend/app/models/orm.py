...
Table names:
    ...
    exam_sessions, student_answers, audio_play_logs,
    results, users
"""
...
class ExamModel(Base):
    ...
    # - its questions are deleted
    # - its exam sets are deleted
    # - its sessions are deleted
    ...
    sets: Mapped[list["ExamSetModel"]] = relationship(
        back_populates="exam",
        cascade="all, delete-orphan",
        passive_deletes=True,
    )

    sessions: Mapped[list["ExamSessionModel"]] = relationship(
        back_populates="exam",
        cascade="all, delete-orphan",
        passive_deletes=True,
    )
...
class QuestionModel(Base):
    ...
    # IMPORTANT:
    # Deleting an exam will delete its questions.
    exam_id: Mapped[int] = mapped_column(
        Integer,
        ForeignKey(
            "exams.id",
...
class OptionModel(Base):
    ...
    option_text: Mapped[Optional[str]] = mapped_column(
        Text
    )
...
class ExamSessionModel(Base):
    ...
    # IMPORTANT:
    # Deleting an exam deletes its exam sessions.
    exam_id: Mapped[int] = mapped_column(
        Integer,
        ForeignKey(
            "exams.id",
    ...
    answers: Mapped[list["StudentAnswerModel"]] = relationship(
        back_populates="session",
        cascade="all, delete-orphan",
        passive_deletes=True,
    )

    audio_plays: Mapped[list["AudioPlayLogModel"]] = relationship(
        back_populates="session",
        cascade="all, delete-orphan",
        passive_deletes=True,
    )

    result: Mapped[Optional["ResultModel"]] = relationship(
        back_populates="session",
        uselist=False,
        cascade="all, delete-orphan",
        passive_deletes=True,
...
class StudentAnswerModel(Base):
    ...
    # IMPORTANT:
    # If a question is deleted, its student answers
    ...
    session: Mapped["ExamSessionModel"] = relationship(
